...
import { useElevationTotem, usePricesPerToken } from 'state/hooks'
...
const ExpeditionCardUserSection: React.FC<HarvestProps> = ({
  ...
  const { pid, rewardToken, userData, roundEmission, totemWinMultipliers } = expedition
  ...
  const userDepositValue: number = useMemo(
    ...
    [effectiveStakedSummit, pricesPerToken]
  )
