    ...
    <Flex flexDirection="column" alignItems="center" justifyContent="center" flex={1} width="100%">
      ...
      <Flex alignItems="center" justifyContent="space-around" width="100%" mb="24px">
        <FlexInfoItem width='200px'>
          ...
          <InfoItemValue>
            <CardValue value={rawYieldContributed} decimals={3} summitPalette={elevation} fontSize="22" />
        ...
        <FlexInfoItem width='200px'>
          ...
          <InfoItemValue>
            <CardValue value={rawPotentialWinnings} decimals={3} summitPalette={elevation} fontSize="22" />
            <HighlightedText bold monospace mt="-8px" summitPalette={elevation}>
              {earnLabel}
            </HighlightedText>
          </InfoItemValue>
      ...
      <Flex alignItems='center' justifyContent='space-around' width="100%">
        <FlexInfoItem width='200px'>
          ...
          <InfoItemValue>
            <CardValue value={rawClaimable} decimals={3} summitPalette={elevation} fontSize="22" />
            <HighlightedText bold monospace mt="-8px" summitPalette={elevation}>
              {earnLabel}
            </HighlightedText>
          </InfoItemValue>
